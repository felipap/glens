...
function GCodeRenderer () {
	...
	this.geoHandlers = {
		...
		G1: function (viewModel) {
			...
			var newLine = {
        x: line.x !== undefined ? absolute(lastLine.x, line.x) : lastLine.x,
        y: line.y !== undefined ? absolute(lastLine.y, line.y) : lastLine.y,
        z: line.z !== undefined ? absolute(lastLine.z, line.z) : lastLine.z,
        e: line.e !== undefined ? absolute(lastLine.e, line.e) : lastLine.e,
        f: line.f !== undefined ? absolute(lastLine.f, line.f) : lastLine.f,
        extruding: false,
      };
    ...
    G92: function (viewModel) { // E0
      ...
      // coordinate to 10, and the extrude coordinate to 90.
